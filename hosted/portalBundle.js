"use strict"; // console.log('hi from portal.tsx');
// - adds a new friend
...
$(document).ready(function () {
  ...
  $('.game-card').each(function (index, el) {
    ReactDOM.render( /*#__PURE__*/React.createElement(GAMECARD, {
      name: $(el).attr('name-prop'),
